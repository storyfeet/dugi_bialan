...
pub fn fontMap(alloc: std.mem.Allocator) !FontMap {
    ...
    try map.put("bi", aux(0xe138));
    try map.put("biagela", nm(0xe139));
    try map.put("biagei", nm(0xe13a));
    try map.put("bialan", nm(0xe13b));
    try map.put("bianei", aux(0xe13c));
    try map.put("biawi", nm(0xe13f));
    try map.put("bog", nm(0xe140));
    ...
    try map.put("da", par(0xe14f));
    try map.put("dan", par(0xe150));
    try map.put("das", nm(0xe151));
    try map.put("demego", nm(0xe152));
    try map.put("degis", nm(0xe153));
    try map.put("deli", nm(0xe154));
    try map.put("delo", nm(0xe155));
    try map.put("devo", nm(0xe156));
    try map.put("denso", nm(0xe157));
    try map.put("deso", aux(0xe158));
    try map.put("devin", aux(0xe159));
    ...
    try map.put("egin", nm(0xe165));
    try map.put("ei", par(0xe166));
    try map.put("elein", nm(0xe167));
    try map.put("eleba", nm(0xe168));
    try map.put("elena", nm(0xe169));
    try map.put("eliasi", nm(0xe16a));
    try map.put("elo", nm(0xe16b));
    try map.put("enbin", nm(0xe16c));
    try map.put("endei", nm(0xe16d));
    try map.put("eniasa", nm(0xe16e));
    try map.put("enin", nm(0xe16f));
    try map.put("enma", nm(0xe170));
    try map.put("enon", nm(0xe171));
    try map.put("ensa", nm(0xe172));
    try map.put("esebin", nm(0xe173));
    try map.put("eselin", nm(0xe174));
    try map.put("esenis", nm(0xe175));
    try map.put("esi", con(0xe176));
    try map.put("esin", nm(0xe177));
    try map.put("esuno", nm(0xe178));
    try map.put("ezan", nm(0xe179));
    try map.put("esegi", nm(0xe17a));
    ...
    try map.put("liazi", nm(0xe1aa));
    try map.put("lin", nm(0xe1ab));
    try map.put("loigo", nm(0xe1ac));
    try map.put("lon", par(0xe1ad));
    try map.put("luga", nm(0xe1ae));
    try map.put("lugin", nm(0xe1af));
    try map.put("luli", nm(0xe1b0));

    try map.put("ma", nm(0xe1b4));
    try map.put("man", nm(0xe1b5));
    try map.put("memuso", nm(0xe1b6));
    try map.put("mengi", nm(0xe1b7));
    try map.put("menuga", nm(0xe1b8));
    try map.put("meseni", nm(0xe1b9));
    try map.put("mezan", nm(0xe1ba));
    try map.put("mezuni", nm(0xe1bb));
